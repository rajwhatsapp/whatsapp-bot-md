...
module.exports = {
  ...
  SUDO: process.env.SUDO || '994407122025,919064884766,918618366532',
  ...
  PERSONAL_MESSAGE: process.env.PERSONAL_MESSAGE || '*This is a bot; my owner will message you back when online*',
  ...
  ADMINS: process.env.GROUP_ADMINS || 'true',
